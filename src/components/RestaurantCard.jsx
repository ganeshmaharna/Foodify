    ...
    <div className="tracking-tight w-[330px] h-[320px] group-hover:scale-95 transition-transform">
      ...
      {avgRating ? (
        <div className="flex items-center gap-1">
          ...
          <div>
            <span className="text-customblack-1 font-GrotBold text-base">
      ...
      <p className="font-GrotThin text-base text-customblack-2">
        {truncateCuisines(cuisines.join(", "))}
      </p>
      <span className="font-GrotThin text-base text-customblack-2">
        {areaName}
      </span>
    </div>
  );
